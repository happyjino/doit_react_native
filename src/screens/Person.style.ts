...
export const styles = StyleSheet.create({
  ...
  leftView: { padding: 5 },
  avatar: { borderColor: color(MD2Colors.blue500).lighten(0.5).string(), borderWidth: 2 },
  rightView: { flex: 1, padding: 5, marginRight: 10 },
  name: { marginRight: 5, fontSize: 22, fontWeight: '500' },
  email: {textDecorationLine: 'underline', textDecorationColor: MD2Colors.blue500, color: MD2Colors.blue500},
